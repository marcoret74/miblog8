...
class PersonasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create persona" do
    assert_difference('Persona.count') do
      post personas_url, params: { persona: { edad: @persona.edad, nombre: @persona.nombre } }
    end
  ...
  test "should update persona" do
    patch persona_url(@persona), params: { persona: { edad: @persona.edad, nombre: @persona.nombre } }
